...
class StandardTypeSet(TypeSet):
  def __init__(self):
    ...
    double_ptr_types = [PointerType(PointerType(ty)) for ty in base_types]
    all_types = default_types + base_types + single_ptr_types + double_ptr_types
...
class ReducedStdTypeSet(TypeSet):
  def __init__(self):
    ...
    double_ptr_types = [PointerType(PointerType(ty)) for ty in [
      CharType(),
      StructType(),
      I32Type(),
      I64Type(),
